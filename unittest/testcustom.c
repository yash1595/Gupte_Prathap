...
{
	CU_ASSERT_EQUAL(Allocate(0,0,10),1);
	CU_ASSERT_EQUAL(Allocate(0,-1,5),0);
	CU_ASSERT_EQUAL(Allocate(0,0,257),0);
	FreeMem(0,0,0);
}
...
{
	CU_ASSERT_EQUAL(DelDataCycBuff(0,0,5),1);	
	CU_ASSERT_EQUAL(DelDataCycBuff(0,0,2),1);
	CU_ASSERT_EQUAL(DelDataCycBuff(0,0,8),0);
	
}
void test_disp_function(void)
{

	CU_ASSERT_EQUAL(DisplayCycBuff(0,0,0), 1);
	
}
void test_free_function(void)
{
	CU_ASSERT_EQUAL(FreeMem(0,0,0), 1);
	CU_ASSERT_EQUAL(FreeMem(0,1,0), 0);
	//CU_ASSERT_EQUAL(FreeMem(0,4,0), 0);
	
}
void test_realloc_function(void)
{
	CU_ASSERT_EQUAL(ReallocBuff(0,0,10),1);
	CU_ASSERT_EQUAL(ReallocBuff(0,0,12),1);
	CU_ASSERT_EQUAL(ReallocBuff(0,4,0),0);
	CU_ASSERT_EQUAL(ReallocBuff(0,0,4),0);
}
